...
## Low-expressed genes can make for noisy data. We'll filter out the lowest-expressed genes (bottom 25%), which corresponds to less than ~16 (or 2^4) reads.
...
## comment out lines 83 & 85 to view your plot in your "plots" window, or leave as-is to save your plot to .pdf
